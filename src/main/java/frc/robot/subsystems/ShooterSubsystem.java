...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private final TalonFX m_topSh = new TalonFX(frc.robot.Constants.ShooterConstants.topShooter);
  private final TalonFX m_botSh = new TalonFX(frc.robot.Constants.ShooterConstants.botShooter);
